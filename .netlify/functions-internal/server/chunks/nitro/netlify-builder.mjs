...
const _runtimeConfig = (function(a,b){return {app:{baseURL:a,buildAssetsDir:"\u002F_nuxt\u002F",cdnURL:b},nitro:{routes:{},envPrefix:"NUXT_"},public:{supabase:{url:"https:\u002F\u002Fhzkrfnrthivtgywwfmzw.supabase.co",key:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh6a3JmbnJ0aGl2dGd5d3dmbXp3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NTAzNjQ5NjYsImV4cCI6MTk2NTk0MDk2Nn0.jnrnzs8luCdj2XyhaN2QDp8O6dGDgDOV9zUGN12X0fw",client:{},cookies:{name:"sb",lifetime:28800,domain:b,path:a,sameSite:"lax"}}}}}("\u002F",""));
...
const _de7a29 = () => import('../handlers/renderer.mjs');
const _c72261 = () => import('../handlers/session.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _de7a29, lazy: true, method: undefined },
  { route: '/api/_supabase/session', handler: _c72261, lazy: true, method: undefined },
  { route: '/**', handler: _de7a29, lazy: true, method: undefined }
];
...
const handler$1 = async function handler2(event, context) {
